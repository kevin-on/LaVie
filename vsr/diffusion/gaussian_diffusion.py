...
class ModelMeanType(enum.Enum):
    ...
    PREVIOUS_V = (
        enum.auto()
    )  # v-parameterization for VSR; (see section 2.4 https://imagen.research.google/video/paper.pdf)
...
class GaussianDiffusion:
    ...
    def training_losses(
        self, model, x_start, t, loss_mask=None, model_kwargs=None, noise=None
    ):
        """
        ...
        ):  # loss_type=LossType.MSE by default
            try:
